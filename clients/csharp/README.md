...
```bash
cd clients/csharp
dotnet run --project SesameContractTest.csproj
```

Dependencies: the base class library only, using `System.Text.Json`.
...
Copy `csharp/Sesame.cs` into your project:
